    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="uName" runat="server" Text="username"></asp:Label>
                ...
                <br />
                <asp:SqlDataSource ID="SqlDataSourceLoginType" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [logintype]"></asp:SqlDataSource>
                <br />
                <br />
